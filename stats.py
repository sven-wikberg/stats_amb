...
if __name__ == "__main__":
    # Le nouveau point d'entrée détecte automatiquement le format Attrib 2026
    # ou l'ancien CSV. Les fonctions historiques ci-dessus sont conservées afin
    # de ne pas perdre le travail existant pendant la migration.
    from ace_quality.cli import main as run_report
